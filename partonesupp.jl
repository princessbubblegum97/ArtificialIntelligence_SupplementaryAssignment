...
function tableschoice(T=Int64,msg="how many tables would you like?(*table selection rules: please select 2 if you selected 2 blocks, 4 if you selected 3 blocks, 1 if you selected 4 blocks) final layout will not be accurate ~hint: try to remember this number as you will need it later: ")
    ...
    if T == String
        ...
        try
            ...
            println("Blocks world does not support this type :-(")
            tableschoice(T, msg)
            readline()
        end
    end
...
t=tableschoice(Int64, "how many tables would you like?(*table selection rules: please select 2 if you selected 2 blocks, 4 if you selected 3 blocks, 1 if you selected 4 blocks) final layout will not be accurate ~hint: try to remember this number as you will need it later: ");println(t);
