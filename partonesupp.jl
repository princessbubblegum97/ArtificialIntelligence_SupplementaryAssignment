...
userdecision = request("define your layout//goal *indicated by asterisk* based on the number of blocks and tables which you chose before to see the plan: ", menu);if userdecision == 1
