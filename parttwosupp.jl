...
choice = request("choose new layout//goal based on your block and table figures (world1 for 3 blocks and 2 tables, world2 for 4 blocks and 3 tables, world3 for 5 blocks and 2 tables orelse final layout will not be accurate) :", menu);if choice == 1
