...
function newlayoutchoice(L=Int64,msg="which new layout would you like? **newlayout selection rules: please enter 1 for -NEWGOAL1 if you selected 3 blocks and 2 tables, please enter 2 for -NEWGOAL2 if you selected 4 blocks and 3 tables, please enter 3 for -NEWGOAL3 if you selected 5 blocks and 2 tables orelse final layout will not be accurate: ")
    print("$msg")
    if L == String
        return readline()
    else
        try
            ...
            println("Blocks world does not support this type :-( Please enter a type int of value: 1, 2 or 3  according to **newlayout selection rules")
            newlayout(L, msg)
            readline()
        end
    end
...
l=secondtablechoice(Int64, "which new layout would you like? **newlayout selection rules: please enter 1 for -NEWGOAL1 if you selected 3 blocks and 2 tables, please enter 2 for -NEWGOAL2 if you selected 4 blocks and 3 tables, please enter 3 for -NEWGOAL3 if you selected 5 blocks and 2 tables orelse final layout will not be accurate: ");println(l)
